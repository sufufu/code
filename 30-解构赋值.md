...
// let [r = s, s] = [undefined, 3]; 报错：当 r 解构出 undefined 时，要使用 s 的值做默认值，但是 s 没声明过，就会报错；当解构变量互为默认值时，注意！
// // console.log(r, s);
...
// 2.1 只想取一个值，比如取 courses；对象解构赋值，你想取哪个就写哪个。
let zf = {
  name: '珠峰',
  age: 10,
